...
// const GPSModule = NativeModules.ViroGPSModule;
 ...
 */
export class ViroRealEstateService {
  private static instance: ViroRealEstateService;
  private isInitialized: boolean = false;
  private config: RealEstateAPIConfig | null = null;
  private watchId: number | null = null;
  private currentLocation: GeoLocation | null = null;
  private locationListeners: ((location: GeoLocation) => void)[] = [];
   ...
   */
  public static getInstance(): ViroRealEstateService {
   ...
   */
  public async initialize(config: RealEstateAPIConfig): Promise<boolean> {
   ...
   */
  public startWatchingLocation(onLocationUpdate?: (location: GeoLocation) => void): Promise<boolean> {
  ...
  public stopWatchingLocation(): void {
    if (this.watchId !== null) {
      ...
      clearInterval(this.watchId as unknown as NodeJS.Timeout);
   ...
   */
  public async getPropertyDetails(propertyId: string): Promise<PropertyDetails> {
   ...
   */
  public async searchProperties(params: PropertySearchParams): Promise<PropertySearchResult> {
    if (!this.isInitialized || !this.config) {
      throw new Error("Real Estate API not initialized");
    }
   ...
   * @param limit Maximum number of results
   */
  public async getPropertiesNearCurrentLocation(
    radius: number = 1000,
    limit: number = 10
  ): Promise<PropertySummary[]> {
   ...
   */
  public async getPropertyDetailsByAddress(address: string): Promise<PropertyDetails | null> {
    try {
   ...
   */
  public async geocodeAddress(address: string): Promise<GeoLocation | null> {
    if (!this.isInitialized || !this.config) {
      throw new Error("Real Estate API not initialized");
    }
   ...
   */
  public async reverseGeocode(location: GeoLocation): Promise<Address | null> {
    if (!this.isInitialized || !this.config) {
      throw new Error("Real Estate API not initialized");
    }
   ...
   */
  public addLocationListener(listener: (location: GeoLocation) => void): void {
   ...
   */
  public removeLocationListener(listener: (location: GeoLocation) => void): void {
   ...
   */
  private notifyLocationListeners(location: GeoLocation): void {
   ...
   * @param propertyId Property ID
   */
  private getMockPropertyDetails(propertyId: string): PropertyDetails {
    return {
      propertyId,
      address: {
        street: "123 Main St",
   ...
   * @param params Search parameters
   */
  private getMockPropertySearchResult(params: PropertySearchParams): PropertySearchResult {
